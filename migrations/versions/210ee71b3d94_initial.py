...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['transfer_id'], ['sample_transfer.id'], ),
    sa.ForeignKeyConstraint(['source_plate_id'], ['sample_plate.id'], ),
    #sa.ForeignKeyConstraint(['source_well_id'], ['well_sample.well_id'], ),
    sa.ForeignKeyConstraint(['destination_plate_id'], ['sample_plate.id'], ),
    #sa.ForeignKeyConstraint(['destination_well_id'], ['well_sample.well_id'], ),

    sa.PrimaryKeyConstraint('transfer_id', 'item_order_number')
    )
    '''

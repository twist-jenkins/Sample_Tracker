...
# Route handlers for the pages of the application.
#
from angular import new_home, user_data, google_login, sample_transfer_types, sample_plate_barcodes, update_plate_barcode, sample_transfers, create_step_record, plate_details, source_plate_well_data

def maps_json():
    return {
        ...
        ,"13": { # keyed to sample_transfer_template_id in the database
            ...
            ,"source_plate_count": 1
            ,"destination_plate_count": 4
            ,"source_plate_well_counts": 384
            ,"source_plate_type_id": "SPTT_0006"
            ,"destination_plate_well_counts": 96
            ,"destination_plate_type_id": "SPTT_0005"
            ,"plate_well_to_well_maps": [ # array of source plates
                [   #  item format: key = source plate well id; value = {destination plate number, destination_well_id}}
